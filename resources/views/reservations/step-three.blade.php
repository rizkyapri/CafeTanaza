            ...
            <div class="flex-1 h-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            <h3 class="mb-4 text-xl font-bold text-blue-600">Upload Screenshot Transfer</h3>
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.three') }}"
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <label for="image" class="block text-sm font-medium text-gray-700 pt-5"> Upload
                                        Bukti screenshot disini
                                    </label>
                                    <div class="mt-1">
